...
/**
 * <p>
 * Java class for responseImpl complex type.
 * 
 * <p>
...
@XmlType(name = "responseImpl", propOrder = { "error", "appendix" })
@XmlSeeAlso({ FlightTrackResponse.class, FlightStatusExtendedsResponse.class, FlightTracksResponse.class,
		FlightStatusesResponse.class, FlightStatusResponse.class, FlightPositionResponse.class })
public abstract class ResponseImpl {
	 ...
	 * 
	 * @return possible object is {@link ApiResponseError }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link ApiResponseError }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link Appendices }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link Appendices }
	 * 
	 */
	...
	public String toString() {
		return "ResponseImpl [error=" + error + ", appendix=" + appendix + "]";
	}
